...
/**
 * Classe CommDriverGenRep: classe de comunicação entre as threads de passageiro (TPassenger) e a zona de recolha de bagagens (MBaggageCollectionPoint) de forma distribuida
 * @author miguel
 */
